...
3.  **MÉTRICAS DO CLIENTE (ENTREGA FINAL):** Configurar Google Analytics 4 (GA4) para que a cliente possa visualizar os acessos e relatórios em um painel externo.
